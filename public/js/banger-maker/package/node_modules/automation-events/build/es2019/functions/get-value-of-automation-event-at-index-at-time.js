import { getTargetValueAtTime } from 'automation-events/build/es2019/functions/get-target-value-at-time';
import { isAnyRampToValueAutomationEvent } from 'automation-events/build/es2019/guards/any-ramp-to-value-automation-event';
import { isSetValueAutomationEvent } from 'automation-events/build/es2019/guards/set-value-automation-event';
import { isSetValueCurveAutomationEvent } from 'automation-events/build/es2019/guards/set-value-curve-automation-event';

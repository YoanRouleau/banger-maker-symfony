...
var _createExtendedExponentialRampToValueAutomationEvent = require("automation-events/build/node/functions/create-extended-exponential-ramp-to-value-automation-event");

var _createExtendedLinearRampToValueAutomationEvent = require("automation-events/build/node/functions/create-extended-linear-ramp-to-value-automation-event");

var _createSetValueAutomationEvent = require("automation-events/build/node/functions/create-set-value-automation-event");

var _createSetValueCurveAutomationEvent = require("automation-events/build/node/functions/create-set-value-curve-automation-event");

var _getEndTimeAndValueOfPreviousAutomationEvent = require("automation-events/build/node/functions/get-end-time-and-value-of-previous-automation-event");

var _getEventTime = require("automation-events/build/node/functions/get-event-time");

var _getExponentialRampValueAtTime = require("automation-events/build/node/functions/get-exponential-ramp-value-at-time");

var _getLinearRampValueAtTime = require("automation-events/build/node/functions/get-linear-ramp-value-at-time");

var _getTargetValueAtTime = require("automation-events/build/node/functions/get-target-value-at-time");

var _getValueCurveValueAtTime = require("automation-events/build/node/functions/get-value-curve-value-at-time");

var _getValueOfAutomationEventAtIndexAtTime = require("automation-events/build/node/functions/get-value-of-automation-event-at-index-at-time");

var _anyRampToValueAutomationEvent = require("automation-events/build/node/guards/any-ramp-to-value-automation-event");

var _cancelAndHoldAutomationEvent = require("automation-events/build/node/guards/cancel-and-hold-automation-event");

var _cancelScheduledValuesAutomationEvent = require("automation-events/build/node/guards/cancel-scheduled-values-automation-event");

var _exponentialRampToValueAutomationEvent = require("automation-events/build/node/guards/exponential-ramp-to-value-automation-event");

var _linearRampToValueAutomationEvent = require("automation-events/build/node/guards/linear-ramp-to-value-automation-event");

var _setTargetAutomationEvent = require("automation-events/build/node/guards/set-target-automation-event");

var _setValueAutomationEvent = require("automation-events/build/node/guards/set-value-automation-event");

var _setValueCurveAutomationEvent = require("automation-events/build/node/guards/set-value-curve-automation-event");

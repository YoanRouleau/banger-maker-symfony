...
export declare const isAnyAudioContext: import("standardized-audio-context/build/es2019/types").TIsAnyAudioContextFunction;
export declare const isAnyAudioNode: import("standardized-audio-context/build/es2019/types").TIsAnyAudioNodeFunction;
export declare const isAnyAudioParam: import("standardized-audio-context/build/es2019/types").TIsAnyAudioParamFunction;
export declare const isAnyOfflineAudioContext: import("standardized-audio-context/build/es2019/types").TIsAnyOfflineAudioContextFunction;

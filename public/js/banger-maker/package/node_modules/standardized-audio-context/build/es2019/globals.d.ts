import { IAudioNode, IAudioWorkletProcessor, IAudioWorkletProcessorConstructor } from 'standardized-audio-context/build/es2019/interfaces';
import { TAudioNodeConnectionsStore, TAudioNodeStore, TAudioParamConnectionsStore, TAudioParamStore, TContext, TContextStore, TCycleCounters, TInternalStateEventListener, TNativeAudioWorkletNode, TNativeContext } from 'standardized-audio-context/build/es2019/types';

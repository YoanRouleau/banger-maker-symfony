import { TAudioContextConstructor } from 'standardized-audio-context/build/es2019/types/audio-context-constructor';
import { TBaseAudioContextConstructor } from 'standardized-audio-context/build/es2019/types/base-audio-context-constructor';
import { TInvalidStateErrorFactory } from 'standardized-audio-context/build/es2019/types/invalid-state-error-factory';
import { TMediaElementAudioSourceNodeConstructor } from 'standardized-audio-context/build/es2019/types/media-element-audio-source-node-constructor';
import { TMediaStreamAudioDestinationNodeConstructor } from 'standardized-audio-context/build/es2019/types/media-stream-audio-destination-node-constructor';
import { TMediaStreamAudioSourceNodeConstructor } from 'standardized-audio-context/build/es2019/types/media-stream-audio-source-node-constructor';
import { TMediaStreamTrackAudioSourceNodeConstructor } from 'standardized-audio-context/build/es2019/types/media-stream-track-audio-source-node-constructor';

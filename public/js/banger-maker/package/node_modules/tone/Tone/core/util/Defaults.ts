import { isAudioBuffer, isAudioNode, isAudioParam } from "tone/Tone/core/util/AdvancedTypeCheck";
import { isDefined, isObject, isUndef } from "tone/Tone/core/util/TypeCheck";

type BaseToneOptions = import("tone/Tone/core/Tone").BaseToneOptions;

 ...
 */
final class Version20210323163025 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE riff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, instrument_id INTEGER NOT NULL, categorie_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, decription VARCHAR(255) NOT NULL, customsongfile VARCHAR(255) NOT NULL)');
